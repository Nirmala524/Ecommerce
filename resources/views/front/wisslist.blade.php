                        ...
                        <table>
                            ...
                            <tbody>
                                <tr>
                                    <td class="product__cart__item">
                                        <div class="product__cart__item__pic">
                                            <img src="{{asset('Front/img/shop/cart/cart-1.jpg')}}" alt="">
                                        </div>
                                ...
                                <tr>
                                    <td class="product__cart__item">
                                        <div class="product__cart__item__pic">
                                            <img src="{{asset('Front/img/shop/cart/cart-2.jpg')}}" alt="">
                                        </div>
                                        <div class="product__cart__item__text">
                                ...
                                <tr>
                                    <td class="product__cart__item">
                                        <div class="product__cart__item__pic">
                                            <img src="{{asset('Front/img/shop/cart/cart-3.jpg')}}" alt="">
                                        </div>
                                        <div class="product__cart__item__text">
                                ...
                                <tr>
                                    <td class="product__cart__item">
                                        <div class="product__cart__item__pic">
                                            <img src="{{asset('Front/img/shop/cart/cart-4.jpg')}}" alt="">
                                        </div>
                                        <div class="product__cart__item__text">
