        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-8">
                    ...
                    <div class="blog__item">
                        <div class="blog__item__pic set-bg" data-setbg="{{asset('Front/img/blog/blog-2.jpg')}}">
                            <div class="blog__pic__inner">
                                <div class="label">Recipes</div>
                                <ul>
                                    <li>By <span>James Myers</span></li>
                    ...
                    <div class="blog__item">
                        <div class="blog__item__pic set-bg" data-setbg="{{asset('Front/img/blog/blog-3.jpg')}}">
                            <div class="blog__pic__inner">
                                <div class="label">Recipes</div>
                                <ul>
                                    <li>By <span>James Myers</span></li>
                    ...
                    <div class="blog__item">
                        <div class="blog__item__pic set-bg" data-setbg="{{asset('Front/img/blog/blog-4.jpg')}}">
                            <div class="blog__pic__inner">
                                <div class="label">Recipes</div>
                                <ul>
                                    <li>By <span>James Myers</span></li>
                            ...
                            <div class="blog__sidebar__recent">
                                <a href="#" class="blog__sidebar__recent__item">
                                    <div class="blog__sidebar__recent__item__pic">
                                        <img src="{{asset('Front/img/blog/br-1.jpg')}}" alt="">
                                    </div>
                                ...
                                <a href="#" class="blog__sidebar__recent__item">
                                    <div class="blog__sidebar__recent__item__pic">
                                        <img src="{{asset('Front/img/blog/br-2.jpg')}}" alt="">
                                    </div>
                                    <div class="blog__sidebar__recent__item__text">
                                ...
                                <a href="#" class="blog__sidebar__recent__item">
                                    <div class="blog__sidebar__recent__item__pic">
                                        <img src="{{asset('Front/img/blog/br-3.jpg')}}" alt="">
                                    </div>
                                    <div class="blog__sidebar__recent__item__text">
                                ...
                                <a href="#" class="blog__sidebar__recent__item">
                                    <div class="blog__sidebar__recent__item__pic">
                                        <img src="{{asset('Front/img/blog/br-4.jpg')}}" alt="">
                                    </div>
                                    <div class="blog__sidebar__recent__item__text">
                                ...
                                <a href="#" class="blog__sidebar__recent__item">
                                    <div class="blog__sidebar__recent__item__pic">
                                        <img src="{{asset('Front/img/blog/br-5.jpg')}}" alt="">
                                    </div>
                                    <div class="blog__sidebar__recent__item__text">
