                ...
                <div class="row">
                    <div class="col-lg-6 col-md-6 col-sm-6">
                        <div class="class__item">
                            <div class="class__item__pic set-bg" data-setbg="{{asset('Front/img/class/class-1.jpg')}}">
                    ...
                    <div class="col-lg-6 col-md-6 col-sm-6">
                        <div class="class__item">
                            <div class="class__item__pic set-bg" data-setbg="{{asset('Front/img/class/class-2.jpg')}}">
                                <div class="label">$35.00</div>
                            </div>
                            <div class="class__item__text">
                    ...
                    <div class="col-lg-6 col-md-6 col-sm-6">
                        <div class="class__item">
                            <div class="class__item__pic set-bg" data-setbg="{{asset('Front/img/class/class-3.jpg')}}">
                                <div class="label">$35.00</div>
                            </div>
                            <div class="class__item__text">
                    ...
                    <div class="col-lg-6 col-md-6 col-sm-6">
                        <div class="class__item">
                            <div class="class__item__pic set-bg" data-setbg="{{asset('Front/img/class/class-4.jpg')}}">
                                <div class="label">$35.00</div>
                            </div>
                            <div class="class__item__text">
                    ...
                    <div class="col-lg-6 col-md-6 col-sm-6">
                        <div class="class__item">
                            <div class="class__item__pic set-bg" data-setbg="{{asset('Front/img/class/class-5.jpg')}}">
                                <div class="label">$35.00</div>
                            </div>
                            <div class="class__item__text">
                                <h5><a href="#">THE ULTIMATE BAKING COURSE</a></h5>
                    ...
                    <div class="col-lg-6 col-md-6 col-sm-6">
                        <div class="class__item">
                            <div class="class__item__pic set-bg" data-setbg="{{asset('Front/img/class/class-6.jpg')}}">
                                <div class="label">$35.00</div>
                            </div>
                            <div class="class__item__text">
                                <h5><a href="#">KIDS BAKING COURSE</a></h5>
